...
1. **Instalar Astro**: Primero, cree un nuevo proyecto de Astro y configure mis cuentas en linea.

2. **Crear Paginas**: Despues aprendi como crear paginas creando nuevos archivos `.astro` y colocandolos en la carpeta `src/pages/`.

3. **Crear Publicaciones del Blog**: Esta es mi primera publicacion! Ahora tengo paginas de Astro y publicaciones en Markdown!
